function recognition_confidence(subjectID,isMRI,mainPath,order, sessionNum,use_eyetracker)
...
goNoGoQuestion = dir([mainPath '/Instructions/recognition_goNoGo_question_visual.JPG' ]);
newOldQuestion = dir([mainPath '/Instructions/recognition_oldNew_question_visual.JPG' ]);
