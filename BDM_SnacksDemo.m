function BDM_SnacksDemo(subjectID,sessionNum)
%=========================================================================
% BDM task
%=========================================================================
...
%---------------------------------------------------------------
fid1=fopen([OutputFolder subjectID '_' StimuliName '_BDMdemo' sessionNum '_' timestamp '.txt'], 'w');
...
for trial=1:length(stimuli_images)
    ...
    while noresp
        ...
        if CurrentX >= AxisFromX && CurrentX <= AxisToX && CurrentY >= AxisFromY - AdditionToYAxisFromEachSide && CurrentY <= AxisToY + AdditionToYAxisFromEachSide
            ...
            for i = 1:length(SpotsForIndicatorsOnAxis) %%%%%%%%%%%%%%%%%%%%5
