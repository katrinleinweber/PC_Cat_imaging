...
% subjectID=[experimentName '_' subjectNum];
...
%=========================================================================
BdmFile=dir([outputPath '/' subjectID '*BDM1*.txt']);
BDM1_data = readtable([outputPath '/' BdmFile.name],'Delimiter','\t');
...
[bids_sort,trialnum_sort_bybid] = sort(BDM1_data.Bid,'descend');
...
stimnames_sorted_by_bid = BDM1_data.Name(trialnum_sort_bybid);
